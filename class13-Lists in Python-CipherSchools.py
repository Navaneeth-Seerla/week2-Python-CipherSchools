...
print(len("navaneeth")) #It says that it can be broken down into four atomic elements

print("navaneeth"+"seerla")
print([1,2,3]+[4,5,6])
...
#join
print(",".join(["navaneeth","jathin","varshit"]))